...
Experiment.prototype = {
    ...
    init: function() {
        ...
        $("#stimlist").val(this.urlparams['stimlist'])
        ...
        audSuffix =
            ...
            Modernizr.audio.ogg == 'maybe' ? '.ogg' :
            Modernizr.audio.mp3 == 'maybe' ? '.mp3' :
            '';
        ...
        $('form#mturk_form')
            .append($('<div id="endForm" class="survey"></div>')
                    ...
                    .load('js-adapt/post-survey.html #endForm > *'));
    ...
    wrapup: function(why) {
        ...
        $('input[name="video_stall"]').click(function() {           
           $(".question_section").removeAttr( 'style' )
           $('#audio_stall').show();
           $('#video_stall').hide(); 
        });
